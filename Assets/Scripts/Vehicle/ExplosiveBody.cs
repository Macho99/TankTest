...
public class ExplosiveBody : NetworkBehaviour, IHittable
{
	...
	[Networked, OnChangedRender(nameof(HitSfxRender)), HideInInspector] 
	public int HitSfxCnt { get; private set; }

	[Networked, OnChangedRender(nameof(CurHpChanged)), HideInInspector] 
